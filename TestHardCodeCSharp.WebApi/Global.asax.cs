...
using TestHardCodeCSharp.Daos;
using TestHardCodeCSharp.Services;
/*add customized code between this region*/
/*add customized code between this region*/
namespace TestHardCodeCSharp.WebApi
{
    ...
    public class WebApiApplication : HttpApplication
    {
        protected void Application_Start()
        {
            ...
            string connectionString = ConfigurationManager.ConnectionStrings["TestHardCodeCSharp"].ConnectionString;
