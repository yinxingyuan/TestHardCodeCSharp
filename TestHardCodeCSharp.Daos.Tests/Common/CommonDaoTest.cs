...
/*add customized code between this region*/
namespace TestHardCodeCSharp.Daos.Tests.Common
{
	...
	where TDdlBuilder : DdlBuilder, new()
	{
		...
		public void BasicSetUp()
		{
			...
			DaoFactory.Instance.ConnectionStringBuilder = new SqlCeConnectionStringBuilder("TestHardCodeCSharp.Entities", baseDirectory, null);
